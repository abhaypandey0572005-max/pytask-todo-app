...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col items-center py-8 sm:py-12 px-4 sm:px-6 relative overflow-x-hidden transition-colors duration-300">
      {/* Dynamic Ambient Glowing Mesh */}
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-gradient-to-br from-rose-500/10 via-indigo-500/10 to-cyan-500/10 dark:from-[#782522]/20 dark:via-indigo-600/15 dark:to-cyan-500/10 blur-[130px] rounded-full pointer-events-none -z-10" />
      <div className="fixed bottom-10 right-10 w-[450px] h-[350px] bg-indigo-500/5 dark:bg-violet-600/10 blur-[150px] rounded-full pointer-events-none -z-10" />
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-300 transition-all cursor-pointer disabled:opacity-50"
            >
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className={`fixed bottom-6 right-6 z-50 px-4 py-3 rounded-2xl text-xs font-bold shadow-2xl backdrop-blur-xl border flex items-center gap-2 ${
              toast.type === 'info'
                ? 'bg-white/95 dark:bg-slate-900/95 text-slate-800 dark:text-slate-200 border-slate-200 dark:border-slate-700/80 shadow-slate-300/50 dark:shadow-black/50'
                : 'bg-emerald-50/95 dark:bg-emerald-950/95 text-emerald-800 dark:text-emerald-300 border-emerald-300 dark:border-emerald-500/40 shadow-emerald-200/50 dark:shadow-emerald-950/50'
            }`}
          >
