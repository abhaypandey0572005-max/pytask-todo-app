...
import { X, Calendar, Folder, Save, Loader2, CheckSquare } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            {/* Ambient inner glow */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#782522]/15 rounded-full blur-3xl pointer-events-none" />

            {/* Top Bar with X and Stitch PyTask Logo */}
            <div className="flex items-center justify-between mb-4">
              ...
              {/* Logo Badge matching Stitch UI */}
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-slate-950 border border-slate-800 shadow-md">
                ...
                <span className="text-xs font-bold text-white tracking-tight">
                  Py<span className="text-cyan-400">Task</span>
                </span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Action Buttons: Cancel and Maroon Save Task */}
